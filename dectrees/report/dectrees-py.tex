...
\begin{tikzpicture}
\begin{axis}[
		xlabel=Validation set fraction,
		ylabel=Classification error (with std),
...
\end{axis}
\end{tikzpicture}
\caption{Classification error after pruning of tree, averaged over several iterations, with standard deviation}
\end{figure}
